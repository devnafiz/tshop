          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{url('/admin/add-coupon')}}" name="add_coupon" id="add_coupon"  enctype="multipart/form-data">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="coupons" id="coupons" minlength="5" maxlength="15" required>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="expiry_date"  data-date="2019-01-02" data-date-format="yyyy-mm-dd" value="2019-01-02" class="datepicker" required>
